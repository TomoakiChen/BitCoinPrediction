...
class LTNNewsClient(HtmlClient):
    ...
    def __init__(self):
        ...
        self.__now_url = None
        self.__now_page = 1
        self.__now_state_date = date.today()
    ...
    def findByInterval(self, since_date = date.today(), until_date = date.today() ):
        self.__now_url = None
        self.__now_page = 1
        self.__now_state_datetime = datetime.now()
        ...
        while True:
            ...
            if AkiDateTimeUtil.checkIsAfterEqSinceDate(self.__now_state_date, since_date) == False:
                break;
        return news_info_list
