...
news_info_list = []
url = 'https://tw.news.yahoo.com/tag/%E6%AF%94%E7%89%B9%E5%B9%A3'
html_client = HtmlClient()
html_parsed_data = html_client.getHtml(url)

# ul[class="stream-container-scroll-template"] > li[class=""StreamMegaItem]
# StreamMegaItem

news_list = html_parsed_data.findAll(class_='StreamMegaItem')
print(len(news_list))
